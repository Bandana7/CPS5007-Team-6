...
const LoginModal = ({ onClose, onNavigate }) => {
  ...
  const handleFacialComplete = async () => {
    try {
      ...
      // Call API to complete the login with wallet and facial verification
      ...
      setTimeout(() => {
        onClose();
        onNavigate('protected'); // Navigate to protected content after successful login
      }, 1500);
    } catch (err) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl p-6 max-w-md w-full">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-gray-900">Login with RadixID</h2>
          <button 
            onClick={onClose}
        ...
        {authStage === 'initial' && (
          <div>
            <p className="text-gray-600 mb-6">
              Login with your Radix wallet and facial verification. No passwords needed.
            </p>
            <button 
        ...
        {authStage === 'complete' && (
          <div className="flex flex-col items-center p-6">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-2">Authentication Successful!</h3>
            <p className="text-gray-600 mb-4 text-center">
              Wallet signature and facial biometrics verified.
            </p>
